...
; (function ($, win, doc, undefined) {
	...
	var menuArray = {"menu":[
		{ "name":"캠페인", "link":"/#", "dep2": [
			{ "name":"특별모금", "link":"/#", "dep3": [ 
				{ "name":"지회별 이벤트 모금", "link":"/#" }
			]},
			{ "name":"크라우드 펀딩", "link":"/#", "dep3": [ 
				{ "name":"펀딩 신청하기", "link":"/#" },
				{ "name":"진행중인 펀딩", "link":"/#" },
				{ "name":"종료된 펀딩", "link":"/#" }
			]},
			{ "name":"나눔캠페인", "link":"/#", "dep3": [ 
				{ "name":"희망나눔캠페인(연말)", "link":"/#" },
				{ "name":"소다수캠페인(연중)", "link":"/#" }
			]}
		]},
		{ "name":"기부", "link":"/#", "dep2": [
			...
			{ "name":"일시기부", "link":"/#", "dep3": [ 
				{ "name":"카드/계좌이체/포인트", "link":"/#" , "dep4": [ 
					{ "name":"개인", "link":"/#" },
					{ "name":"법인", "link":"/#" }
				]},
				{ "name":"ARS/문자", "link":"/#", "dep4": [ 
					{ "name":"개인", "link":"/#" },
					{ "name":"법인", "link":"/#" }
				]}
			]},
			{ "name":"기부참여방법", "link":"/#", "dep3": [ 
				{ "name":"착한가정", "link":"/#" },
				{ "name":"착한가게", "link":"/#" },
				{ "name":"착한일터", "link":"/#" },
				{ "name":"나눔리더", "link":"/#" },
		...
		{ "name":"사업", "link":"/#", "dep2": [
			{ "name":"지원사업", "link":"/#", "dep3": [ 
				{ "name":"영역별 지원", "link":"/#" },
				{ "name":"나눔과 변화 스토리", "link":"/#" },
				{ "name":"지원안내", "link":"/#" },
				{ "name":"온라인 배분신청", "link":"/#" }
			]},
			{ "name":"나눔문화 활성화", "link":"/#", "dep3": [ 
				{ "name":"나눔문화연구소", "link":"/#" },
				{ "name":"UWW아태교육센터", "link":"/#" },
				{ "name":"소통과 협력", "link":"/#" },
				{ "name":"어린이 나눔체험관", "link":"/#" },
		...
		{ "name":"사랑의 열매", "link":"/#", "dep2": [
			...
			{ "name":"신뢰와 투명성", "link":"/#", "dep3": [ 
				{ "name":"시민참여위원회", "link":"/#" },
				{ "name":"경영공시", "link":"/#" },
				{ "name":"시민제안/사이버신문고", "link":"/#" }
			]}
		]}		
	]};
	var menuArrayF = {"menu":[
		{ "name":"기부참여 안내", "link":"/#", "dep2": [
			{ "name":"첫 기부 가이드", "link":"/#" },
			{ "name":"나의 기부 설계", "link":"/#" },
			{ "name":"기부 FAQ", "link":"/#", "dep3": [ 
				{ "name":"참여 안내", "link":"/#" },
				{ "name":"기부금 세금공제 안내", "link":"/#" }
			]},
			{ "name":"나의 기부", "link":"/#", "dep3": [ 
				{ "name":"기부내역 조회", "link":"/#" },
				{ "name":"기부확인서 신청/발급", "link":"/#" },
				{ "name":"기부 상담(나눔콜센터)", "link":"/#" }
			]}
		]},
		{ "name":"기부자 그룹", "link":"/#", "dep2": [
			{ "name":"아너 소사이어티", "link":"/#" , "dep3": [
				{ "name":"아너 소사이어티란", "link":"/#" },
				{ "name":"걸어온 길", "link":"/#" },
				{ "name":"현황", "link":"/#" },
				{ "name":"참여안내", "link":"/#" },
			...
			{ "name":"W아너 소사이어티", "link":"/#" , "dep3": [
				{ "name":"W아너 소사이어티란", "link":"/#" },
				{ "name":"걸어온 길", "link":"/#" },
				{ "name":"현황", "link":"/#" }
			]},
			{ "name":"레거시클럽", "link":"/#" },
		...
		{ "name":"각종 신청", "link":"/#", "dep2": [
			{ "name":"온라인 배분신청", "link":"/#" },
			{ "name":"나눔체험관 견학 신청", "link":"/#" },
			{ "name":"기관방문 신청", "link":"/#" },
			{ "name":"대관 신청", "link":"/#" },
			{ "name":"관람 신청", "link":"/#" },
		]},
