...
! function(t) {
    ...
    function o(t) {
        ...
        var O = b()(n, "action.config.affectedElements", {})[g || y] || {},
            ...
            T = void 0,
            k = n && u(i(n.target));
        if (j ? (I = O.limitAffectedElements, E = k, T = u(O)) : E = T = u({
                id: g,
                selector: y,
                selectorGuids: m
            }), null == E || null == T) return [];
        if (n && x) {
            var M = r ? [r] : c(k);
            return x === A.f ? c(T).filter(function(t) {
                return M.some(function(e) {
                    return d(e, t)
                })
            }) : x === A.v ? c(T).filter(function(t) {
                return M.some(function(e) {
                    return p(e, t)
                })
            }) : M
                ...
                return function(t, e) {
                    ...
                    switch (e) {
                        ...
                        case E.l:
                            var c = [u(U, t), u(Q, t)];
                            return {
                                xValue: x()(parseFloat(c[0]), n.xValue), yValue: x()(parseFloat(c[1]), n.yValue)
                            };
                        default:
                            return
                    }
    ...
    window.tram = function(t) {
        ...
        function u(t, e, n) {
            ...
            var r = n;
            return U.test(t) || !Q.test(t) ? r = parseInt(t, 10) : Q.test(t) && (r = 1e3 * parseFloat(t)), 0 > r && (r = 0), r == r ? r : n
        }
        ...
        var M = e.frame = function() {
            ...
            D = s(function(t) {
                ...
                t.init = function(t, e, n, o) {
                    ...
                    var c = e[0];
                    n[2] && (c = n[2]), H[c] && (c = H[c]), this.name = c, this.type = n[1], this.duration = u(e[1], this.duration, r), this.ease = function(t, e, n) {
            ...
            V = s(D, function(t, e) {
                function n(t, e) {
                    var n, r, i, o, a;
                    for (n in t) i = (o = B[n])[0], r = o[1] || n, a = this.convert(t[n], i), e.call(this, r, a, i)
                }
                t.init = function() {
                    e.init.apply(this, arguments), this.current || (this.current = {}, B.perspective && G.perspective && (this.current.perspective = G.perspective, W(this.el, this.name, this.style(this.current)), this.redraw()))
                }, t.set = function(t) {
        ...
        A.transform && (q.transform = [V], B = {
            ...
            skewX: [w],
            skewY: [w]
        }), A.transform && A.backface && (B.z = [b, "translateZ"], B.rotateZ = [w], B.scaleZ = ["number"], B.perspective = [m]);
        var U = /ms/,
            Q = /s|\./;
        return t.tram = e
    }(window.jQuery)
    ...
    function o(t, e) {
        ...
        if (r && o && h && s && (h = Object(P.k)({
            ...
            v && g && e.dispatch(Object(D.actionListPlaybackChanged)({
                actionListId: r,
                isPlaying: !s
            }))
        }
        ...
        n ? d({
            ...
            k()(n, function(t) {
                if (!t.continuous) {
                    var n = t.actionListId,
                        r = t.verbose;
                    h(t, e), r && e.dispatch(Object(D.actionListPlaybackChanged)({
                        actionListId: n,
                        isPlaying: !1
                    }))
                }
                    ...
                    var f = function(t) {
                        ...
                        d = function(t) {
                            ...
                            i.split(" ").filter(Boolean).forEach(function(t) {
                                r.addEventListener(t, f), n.dispatch(Object(D.eventListenerAdded)(r, [t, f]))
                            })
                        };
            ...
            t.getState().ixSession.eventListeners.length && function(t) {
                function e() {
                    ...
                    if (i !== n.viewportWidth) {
                        ...
                        t.dispatch(Object(D.viewportWidthChanged)({
                            width: i,
                            mediaQueries: o
                        }))
                    }
                ...
                W.forEach(function(n) {
                    window.addEventListener(n, e), t.dispatch(Object(D.eventListenerAdded)(window, [n, e]))
                });
                e()
            }(t)
    ...
    function d(t) {
        ...
        k()(i, function(t) {
            t.actionListId === r && t.eventId === n && (h(t, e), t.verbose && e.dispatch(Object(D.actionListPlaybackChanged)({
                actionListId: r,
                isPlaying: !1
            })))
        })
    ...
    function v(t) {
        var e = t.store,
            ...
            i = n.immediate,
            o = Object(P.f)();
        e.dispatch(Object(D.instanceAdded)($({
            instanceId: o
        }, n))), i ? function(t, e) {
    ...
    function g(t, e) {
        ...
        if (Object(P.n)(b, y.mediaQueryKey) && (r || n || i) && ((o || f && i) && Object(P.m)(t, R), i)) {
            if (l) {
                ...
                d && !w && e.dispatch(Object(D.actionListPlaybackChanged)({
                    actionListId: s,
                    isPlaying: !1
                }))
            }
    ...
    n(85), n(87), n(89), n(234), n(235), n(236), n(237), n(238), t.exports = n(239)
}, function(t, e, n) {
    var r = n(1);
    ...
    r.define("dropdown", t.exports = function(t, e) {
        ...
        function o(n, i) {
            ...
            }(l), o.off(y), l.toggle.off(y), a(l), l.nav && l.nav.off(y), l.nav = o.closest(".w-nav"), l.nav.on(b, u(l)), d ? o.on("setting" + y, u(l)) : (l.toggle.on(f() + y, function(t) {
                return e.debounce(function() {
                    t.open ? s(t) : c(t)
                })
            }(l)), l.config.hover && l.toggle.on("mouseenter" + y, function(t) {
                return function() {
                    t.hovering = !0, c(t)
                }
            }(l)), o.on(b, u(l)), h && (l.hovering = !1, s(l)))
        }

        function a(t) {
            var e = Number(t.el.css("z-index"));
            t.manageZ = e === x || e === x + 1, t.config = {
        ...
        function u(t) {
            return function(e, n) {
                return n = n || {}, "w-close" === e.type ? s(t) : "setting" === e.type ? (a(t), !0 === n.open && c(t), void(!1 === n.open && s(t, !0))) : void 0
            }
        }
        ...
        var l, d, p = {},
            ...
            x = 900,
            _ = !1;
        return p.ready = n, p.design = function() {
            _ && v.find(y).each(function(e, n) {
    ...
    e.a = (i = {}, r(i, v.x, M()), r(i, v.y, C()), r(i, v.d, M()), r(i, v.c, C()), r(i, v.n, M(!1)), r(i, v.m, C(!1)), r(i, v.z, M()), r(i, v.A, C()), r(i, v.f, h({}, O, {
        types: "click"
    })), r(i, v.k, h({
        types: "click"
    }, O, {
        ...
        handler: function(t) {
            ...
            return N !== o.scrollPercent && n.dispatch(Object(p.parameterChanged)(C, N)), {
                scrollPercent: N
            }
        }
    ...
    r.define("tabs", t.exports = function(t) {
        function e() {
            s = h && r.env("design"), (c = d.find(y)).length && (c.each(a), r.env("preview") && !x && c.each(o), n(), r.redraw.on(f.redraw))
        }
        ...
        function a(e, n) {
            ...
            if (i || (i = t.data(n, y, {
                    el: r,
                    config: {}
                })), i.current = null, i.menu = r.children(".w-tab-menu"), i.links = i.menu.children(".w-tab-link"), i.content = r.children(".w-tab-content"), i.panes = i.content.children(".w-tab-pane"), i.el.off(y), i.links.off(y), function(t) {
                    var e = {};
        ...
        function u(e, n) {
            function i() {
                if (d.removeClass(b).css({
                        ...
                        width: "",
                        height: ""
                    }), f.addClass(b).each(w.intro), r.redraw.up(), !o.intro) return l(f).set({
                    opacity: 1
                });
                l(f).set({
                    opacity: 0
            ...
            if (u !== e.current) {
                ...
                d.length && o.outro ? (d.each(w.outro), l(d).add("opacity " + o.outro + "ms " + a, {
                    fallback: v
                }).start({
                    opacity: 0
                }).then(i)) : i()
        ...
        var c, s, f = {},
            ...
            w = i.triggers,
            x = !1;
        return f.ready = f.design = f.preview = e, f.redraw = function() {
            x = !0, e(), x = !1
        }, f.destroy = function() {
                ...
                "config": {
                    ...
                    "affectedElements": {
                        ...
                        "5a7bc61b5301890001e60d88|896c3f88-47da-ae3c-121a-013228f5d162": {
                            ...
                            "selectorGuids": ["aab4cf6a-b929-196f-9884-f9dd5175e372", "aeb030a6-cf06-c8fc-0d36-8b92a6d3aa3e"],
                            "limitAffectedElements": null
                        }
                    },
                    "duration": 0
                ...
                "config": {
                    ...
                    "affectedElements": {
                        "5a7bc61b5301890001e60d88|53d3a6af-d38d-4623-ee39-ecf0f977bb2e": {
                            ...
                            "selectorGuids": ["ec2e1218-16a0-96c3-cba9-0855dfff1b54", "c4f422ff-91b3-b5a7-222f-452b91e9ccd1"],
                            "limitAffectedElements": null
                        },
                        "5a7bc61b5301890001e60d88|d8489c88-da08-89e6-0af6-13e9a17d2892": {
                            "selector": ".activity-pill._2",
                            "selectorGuids": ["ec2e1218-16a0-96c3-cba9-0855dfff1b54", "e518713c-bb3d-3a22-da8b-dd509f11864e"],
                            "limitAffectedElements": null
                        },
                        "5a7bc61b5301890001e60d88|4924e324-d86c-efcb-e065-94ceb8bc525c": {
                            "selector": ".activity-pill._3",
                            "selectorGuids": ["ec2e1218-16a0-96c3-cba9-0855dfff1b54", "a225bf12-f898-dd40-e542-b1eb0e16d7e8"],
                            "limitAffectedElements": null
                        },
                        "5a7bc61b5301890001e60d88|025ba718-3b59-d7c6-7072-7f38bbebea1d": {
                            "selector": ".activity-pill._4",
                            "selectorGuids": ["ec2e1218-16a0-96c3-cba9-0855dfff1b54", "18daed7f-a55b-13c8-d12a-34588c3da6bb"],
                            "limitAffectedElements": null
                        }
                    },
                    "duration": 0
            ...
            "actionItemGroups": [{
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "duration": 500,
                        "target": {
                            "id": "47e445f6-a9e2-ff76-a91a-958fd4a8bc2e"
                        },
                        "value": 0,
                        "unit": ""
                    }
