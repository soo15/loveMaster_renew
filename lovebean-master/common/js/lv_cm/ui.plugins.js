...
//				var html_btn = '<button type="button" class="ui-select-btn '+ _hid +'" id="' + sel_id + '_inp" role="combobox" aria-autocomplete="list" aria-owns="' + list_id + '" aria-haspopup="true" aria-expanded="false" aria-activedescendant="' + opt_id_selected + '" data-n="' + sel_n + '" data-id="' + sel_id + '"';
                ...
                // 200701 접근성 요청 수정
                var html_btn = '<button type="button" tabindex="-1" class="ui-select-btn '+ _hid +'" id="' + sel_id + '_inp" role="combobox" aria-autocomplete="list" aria-owns="' + list_id + '" aria-haspopup="true" aria-expanded="false" aria-activedescendant="' + opt_id_selected + '" data-n="' + sel_n + '" data-id="' + sel_id + '"';
...
//				$sel.addClass('off').attr('aria-hidden', true).attr('tabindex', -1);
                ...
                // --200701 접근성 요청 수정
                //$sel.addClass('off');
				$sel.addClass('off').attr('aria-hidden', true);
...
//			$btn.attr('role', 'tab');
			...
			for (i = 0; i < len; i++) {
				...
				//_$btn.attr('aria-controls', id_pnl)[attrs]('tabindex', '')[cls]('selected');
				_$btn[attrs]('tabindex', '')[cls]('selected');
				...
				if (is_current) {
					...
					_$btn.addClass('selected').append('<b class="hide">선택됨</b>');
				} else {
					//_$btn.attr('aria-selected', false).removeClass('selected').find('b.hide').remove();
					_$btn.removeClass('selected').find('b.hide').remove();
				}
