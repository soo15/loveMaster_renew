 ...
 * @description 일반적인 Ajax 호출
 *******************************************************/
function gf_sendAsync(){
    var args = gf_sendAsync.arguments;
    ...
    myajax.sendAsync(actionUrl, param, gf_getAfterFunction(actionUrl, callbackFunction), syncBool);
