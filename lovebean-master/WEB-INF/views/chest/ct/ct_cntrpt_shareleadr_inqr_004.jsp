...
function insertCompanyAfter( data ) {
    if( data.result > 0 ) {
        ...
        location.href = url + "/initShareleadr.do";
...
<form id="companyFrm" name="companyFrm" method="post" >
    ...
    <input type="hidden" name="cn" id=""  value="기부_기부참여방법_나눔리더_상담신청" />
</form>
...
<main class="base-main" id="baseMain">
    <div class="contents-area">
        <div class="contents-hd">
            <h3><strong>나눔리더</strong><span>나눔으로 희망을 비출 나눔리더를 모십니다.</span></h3>
        ...
        <div class="seo-box">
            <div class="area-type-a type2">
                <img src="/common/img/contents/donation-logo13.png" alt="나눔리더" >
                <p class="area-type-tit color-type1 mgt-xxl mgb-n">‘나눔실천으로 지역사회의 나눔문화를 선도하는 개인기부자’</p>
                <p>나눔리더는 1년 내 100만원 이상 기부하신 분이라면 누구나 가입가능한 기부 프로그램입니다.<br>나눔을 통해 우리 사회의 희망을 밝히고자 하는 많은 분들이 나눔리더에 동참하고 있습니다.<br>2019년 6월 기준 전국 1,254명의 나눔리더가 함께하고 있습니다.</p>
            </div>

            <div class="donation-section">
                <h4 class="table-tit">나눔리더 진행절차</h4>
              ...
              <!--     <div class="btn-area">
                ...
                <h4 class="table-tit">나눔리더 사례</h4>
                <div class="donation-article">
                    <div class="gallery-list col-3">
                        <ul>
                            <li>
                                <a href="#" class="gallery-link">
                                    <div class="gallery-img"><img src="/common/img/contents/donation-ex/donation-ex13_01.png" alt="" ></div>
                                    <p class="gallery-tit"><b>나눔리더_<br>[대구] 대구광역시의사회 단체가입</b></p>
                                </a>
                            </li>
                            <li>
                                <a href="#" class="gallery-link">
                                    <div class="gallery-img"><img src="/common/img/contents/donation-ex/donation-ex13_03.png" alt="" ></div>
                                    <p class="gallery-tit"><b>나눔리더_<br>[인천] 인천벤처기업협회,<br>나눔리더 25명 단체 가입</b></p>
                                </a>
                            </li>
                            <li>
                                <a href="#" class="gallery-link">
                                    <div class="gallery-img"><img src="/common/img/contents/donation-ex/donation-ex13_04.png" alt="" ></div>
                                    <p class="gallery-tit"><b>나눔리더_<br>멜로망스 김민석 가입</b></p>
                                </a>
                            </li>
                        </ul>
                    </div>
