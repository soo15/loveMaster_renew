...
var _path = "<%=path%>";
    ...
    /*===========================================================
     * 착한일터 자세히보기 버튼 클릭시 Function !!
     *===========================================================*/
    $(document).on("click", "#btnMore", function(e){

        gf_submitMovePage("<c:url value='/ct/cntrpt/initNicespt.do' />", "" );
...
<form id="companyFrm" name="companyFrm" method="post" >
	...
	<input type="hidden" name="reqstManageTy" id=""  value="0009"/> <!-- HP0025 -->
    ...
    <input type="hidden" name="reqstCn" id="reqstCn" />
			...
			<div class="sub-visual visual01_01">
				<div class="sub-title-area">
					<h2 class="heading-title-a">정기기부</h2>
			...
			<main class="base-main" id="baseMain">
				<div class="contents-area">
					<div class="contents-hd">
						<h3><strong id="eventNm">착한일터</strong><span>당신의 나눔이 모두의 행복입니다. 나눔의 힘을 믿어보세요.</span></h3>
					...
					<input type=hidden name="jihoe" 			id="jihoe" />
						...
						<div class="area-type-a type8">
							...
							<p class="area-type-tit color-type1 mgt-xxl mgb-n">여러분의 정성으로 모아진 성금은 사랑의열매 전문위원들의 투명하고 <br>공정한 심사를 거쳐 도움이 필요한 이웃에게 지원됩니다. </p>
							<p>약정하신 기부금은 급여일에 계좌이체로 자동공제 되어지며 <br>소중한 기부금 전액 연말소득공제의 혜택을 받으실 수 있습니다.</p>
						</div>

						<div class="ui-tab ui-tab-type2 contents-tab mgt-xxxl" id="uiTabguide1">
						<!-- E : 2019-10-28 modify -->

							<div class="ui-tab-btns" btn-id="uiTabguide1">
								<button type="button" class="ui-tab-btn"><i>개인</i></button>
								<button type="button" class="ui-tab-btn"><i>단체</i></button>
							</div>
...
<!-- 												<p class="select-desc">온라인계좌이체 기부시 <span>후원금_KG 이니시스, KG 이니시스</span>로 표시되어 청구됩니다.</p> -->
										...
										<div class="tb-type_a mb-type">
											<table summary="기부자 정보 입력">
												...
												<tr>
													<th scope="row">
														<label for="bplcNm">사업장명<span class="required" aria-label="필수">*</span></label>
													</th>
													<td><input type="text" class="form-w01" id="bplcNm" name="bplcNm" title="사업장명"></td>
												</tr>
												</tbody>
											</table>
										</div>
  ...
  라. 개인정보를 제공받는 자의 보유 및 이용기간 :
     ...
     기타 : 모금회가 정한 보존기간동안</textarea>
										...
										<div class="btn-area">
											...
											<button type="button" class="btn-base-line fl-item-r" id="btnMore">착한일터 소개 자세히보기</button>
										</div>
										<!-- 기부하기 -->
...
<!--                                 <input type="text" class="inp-base" title="인증번호" placeholder="인증번호를 입력하세요." id="cckfunr02_i5"> -->
...
(function($, win, doc, undefined) {
	$(doc).ready(function(){
		...
		//메뉴는 00 부터 시작
// 	    $plugins.common.init({
// 			menuid: '01_00_03' //1depth_2depth_3depth
// 		});
...
function makeSelectBoxEventCode( setleMthd ) {
	var arr = new Array();
	for( var i=0; i<2; i++ ) {
		if( i==0 ) param = {"mysCl1":"07" , "mysCl2":"02", "setleMthd": setleMthd , "speclMysAt": _speclMysAt , "eventCode":_eventCode};
		else param = {"mysCl1":"08" , "mysCl2":"04", "setleMthd":"" , "speclMysAt": "" , "eventCode":""};
		arr.push( param );
	}
