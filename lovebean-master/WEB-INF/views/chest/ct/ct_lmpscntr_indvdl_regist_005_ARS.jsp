...
<main class="base-main" id="baseMain">
				<div class="contents-area">
					<div class="contents-hd">
						<h3><strong>ARS/문자/무통장입금</strong><span>당신의 나눔이 모두의 행복입니다. 나눔의 힘을 믿어보세요.</span></h3>
						<div class="contents-menu-nav"></div>
					</div>

					<div class="seo-box">
						<div class="ars-area">
                            <p class="ars_txt">사랑을 나누는 가장 쉬운 방법, ARS와 문자로 나눔을 실천해보세요.</p>
                            <ul class="ars-list">
                                <li class="ars-item">
                                    <i class="ico-ars01"></i>
                                    <p class="ars-type">ARS</p>
                                    <p class="ars-number">060-700-1212</p>
                                    <p class="ars-info">(한 통화에 3천원)</p>
                                </li>
                                <li class="ars-item">
                                    <i class="ico-ars02"></i>
                                    <p class="ars-type">문자</p>
                                    <p class="ars-number">#9004</p>
                                    <p class="ars-info">(한 통화에 2천원)</p>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="fake-table-box type2">
														...
														<dl class="fake-table-item">
															...
															<dt class="fake-table-th">
																...
																<p class="account-num"><i class="sprite-group-tel"></i>041-635-0340</p>
                        ...
                        <div class="donate-list">
                            ...
                            <p class="donate-desc">온라인계좌이체 기부시 <span>후원금_KG 이니시스, KG 이니시스</span>로 표시되어 청구됩니다.
                            <br/>ARS/문자 기부는 통신사에서 통화내역 확인서를 보내주셔야만 기부금 영수증 발행이 가능합니다                            
                            </p>
                        </div>
