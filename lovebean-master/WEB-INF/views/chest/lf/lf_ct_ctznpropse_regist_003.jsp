...
<script type="text/javascript">
    ...
    function refreshForm(){
        gf_submitMovePage("<c:url value='/lf/ct/initCtznpropse.do' />", "pLinkSepCd=menuLink");
    }
</script>
...
<main class="base-main" id="baseMain">
    <div class="contents-area">
        ...
        <div class="seo-box">
            ...
            <input type="hidden" name="ctznPropseSe" id="ctznPropseSe" value="01" />
            <div class="tb-type_a mb-type">
                <table summary="시민제안">
                    <caption>시민제안 신청정보 설정입니다.</caption>
                    <colgroup>
                        <col class="col-xs">
                        <col class="col-auto">
                    </colgroup>
                    ...
                    <tbody>
                    <tr>
                        <th scope="row"><label for="ctznPropseDetailSe">분야</label></th>
                        <td colspan="3">
                            <div class="ui-select form-w01">
                                <select id="ctznPropseDetailSe" name="ctznPropseDetailSe" class="_required" title="분야">
                                    <c:out value="${comboCtznPropseDetailSe}" escapeXml="false" />
                                </select>
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td colspan="3"><input type="text" class="form-w01 _required" name="ctznPropseNm" id="ctznPropseNm" title="이름"></td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="3">
                            <div class="phone-area">
                                ...
                                <button type="button" class="btn-base-imp small" id="btnCheckPlus" title="새 창 열림">본인인증</button>
                            </div>
            ...
            <div class="terms-group">
                ...
                <textarea id="agreAt1Chk" class="inp-base" readonly="readonly" title="개인정보 수집 및 이용에 동의에 관한 정보입니다.">사회복지공동모금회(이하 “모금회”라 함)는 「개인정보 보호법」제15조에 의거하여 개인정보수집 및 이용에 관한 정보주체의 동의절차를 준수하며, 고지 후 수집된 정보는 모금회의 개인정보 수집 및
...
본인은 모금회가 「개인정보 보호법」제15조제1항 및 제24조제1항제1호에 의거, 다음과 같이 본인의 개인정보 및 고유식별정보(이하 “개인정보”라 함)를 수집ㆍ이용하는 것에 대하여 동의합니다.
  ...
  라. 개인정보의 보유 및 이용기간 : 1.주민등록번호 : 기부금 입금일을 기준으로 소득공제가 실시되는 기간동안, 2.기타 : 모금회가 정한 보존기간동안</textarea>
                ...
                <textarea id="agreAt2Chk" class="inp-base" readonly="readonly" title="개인정보 제 3자 제공에 동의에 관한 정보입니다.">본인은 모금회가 「개인정보 보호법」제17조제1항제1호에 의거, 다음과 같이 본인의 개인정보를 제3자에게 제공하는 것에 대하여 동의합니다.
