 ...
 *************************************************************************************************
 */
public interface ScaMapper {
    /**
     * [ 나눔체험신청 ] 기부상담신청 신청  및 수정하기 ( 신청하기 TAB ) 
     * @param paramMap
     * @return cnt
     * @throws Exception
     * 나눔체험신청 테이블 에 INSERT 
     */ 
    public int insertTHP_LnbnsReqst(Map<String, String> paramMap) throws Exception;
     ...
     */ 
    public int updateCancelTHP_LnbnsReqst(Map<String, String> paramMap) throws Exception;
     ...
     */ 
    public List<ComCamelMap> selectTHP_LnbnsReqst(Map<String, String> paramMap) throws Exception;
